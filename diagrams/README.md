...
This folder contains architecture and workflow diagrams for AWS_Error_Driven_Troubleshooting_Lab.
...
**Note**: Diagrams will be added to illustrate system architecture and workflows.
